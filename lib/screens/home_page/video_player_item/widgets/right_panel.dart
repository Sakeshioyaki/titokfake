      ...
      child: Column(
        children: [
          GestureDetector(
            onTap: () {
              // logic.setLikeAction();
              videoPlayerItemController.setLiked(false);
            },
          ...
          return Container(
            ...
            child: Column(
              children: [
                GestureDetector(
                  onTap: () {
                    videoPlayerItemController.setLiked(true);
                    logic.setLikeAction(true);
                  },
                  child: const Icon(Icons.favorite,
                      size: 29, color: AppColors.whiteAuth),
                ),
                const SizedBox(height: 9),
                Text(
                  likes ?? '',
